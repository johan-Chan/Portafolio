...
<body>
    ...
    <center>
        <form name="form_img" action="insertaciontipo.php" method="POST" enctype="multipart/form-data">
            <div class="contenedor">
                <input type="text" name="idest" placeholder="Digite el Id de tipo" class="auyama" required>
                <br><br>
